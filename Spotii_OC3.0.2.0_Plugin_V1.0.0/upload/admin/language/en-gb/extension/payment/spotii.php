...
$_['text_spotii']                    = '<a target="_BLANK" href="https://www.spotii.me"><img src="view/image/payment/spotii.png" alt="Spotii Website" title="Spotii Website" style="border: 1px solid #EEEEEE; max-width: 20%; max-height: auto" /></a>';
$_['text_live']                      = 'Live';
...
//Errors
$_['error_permission']               = 'Warning: You do not have permission to modify payment Spotii!';
$_['error_merchant_private_key']     = 'Merchant Private Key required!';
$_['error_spotii_public_key']        = 'Spotii Public Key required!';