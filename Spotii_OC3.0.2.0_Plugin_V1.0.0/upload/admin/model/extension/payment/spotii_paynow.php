...
class ModelExtensionPaymentSpotiipaynow extends Model
{
    ...
    public function validateKeys($data){
        $auth_url =  $data['payment_spotii_paynow_test'] == "sandbox" ? 'https://auth.sandbox.spotii.me/api/v1.0/merchant/authentication/' : 'https://auth.spotii.me/api/v1.0/merchant/authentication/';
        $body = array(
            'public_key' => $data['payment_spotii_paynow_spotii_public_key'],
            'private_key' => $data['payment_spotii_paynow_merchant_private_key']
        );
